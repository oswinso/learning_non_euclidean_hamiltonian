...
public:
  ...
  typename std::array<T, 3>::iterator begin() { return m.begin(); }
  typename std::array<T, 3>::const_iterator begin() const { return m.begin(); }

  typename std::array<T, 3>::iterator end() { return m.end(); }
  typename std::array<T, 3>::const_iterator end() const { return m.end(); }
...
public:
  Matrix() = default;
  explicit Matrix(T t) : m{{t, t, t, t, t, t, t, t, t}} {}
  Matrix(const Matrix &rhs) = default;
  Matrix(Matrix &&rhs) noexcept : m(std::move(rhs.m)), nc(rhs.nc), nr(rhs.nr) {}
  ...
  typename std::array<T, 9>::iterator begin() { return m.begin(); }
  typename std::array<T, 9>::const_iterator begin() const { return m.begin(); }

  typename std::array<T, 9>::iterator end() { return m.end(); }
  typename std::array<T, 9>::const_iterator end() const { return m.end(); }
